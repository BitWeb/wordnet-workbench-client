    ...
    angularAMD.controller('controller/synset/RelationTrees', ['$scope','$state', '$stateParams', '$log', 'wnwbApi', function ($scope, $state, $stateParams, $log, wnwbApi) {
        ...
        $scope.anchorSynSetPromise.then(function (synSet) {
            ...
            hyperonymRelTreePromise.then(function (result) {
                ...
                var rootCollection = [];
                $scope.hyperonymRelTree.push({id: synSet.id, name: synSet.label, nodes: rootCollection});
            ...
            hyponymRelTreePromise.then(function (result) {
                ...
                {
                    var rootCollection = [];
                    $scope.firstHyponymRelTree.push({id: synSet.id, name: synSet.label, nodes: rootCollection});
                ...
                {
                    var rootCollection = [];
                    $scope.hyponymRelTree.push({id: synSet.id, name: synSet.label, nodes: rootCollection});
